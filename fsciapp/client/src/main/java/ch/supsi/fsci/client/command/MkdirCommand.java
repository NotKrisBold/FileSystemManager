...
public class MkdirCommand extends Command implements ActsOnFileSystem {
    ...
    protected MkdirCommand(String fullinputCommand, List<String> argumentList) {
    ...
    @Override
    public void execute() {
        fileSystemHandler.mkdir(directoryName,getFullInputCommand());
    }
